...
int main()
{
	...
	/*test_ABt(28 * 28, 128, 64, 10000);
	test_ABt(14 * 14, 256, 128, 10000);
	
	test_ABt(56 * 56, 128, 64, 10000);
	test_ABt(28 * 28, 256, 128, 10000);
	test_ABt(14 * 14, 512, 256, 10000);

	test_ABt(56 * 56, 128, 64, 10000);
	test_ABt(28 * 28, 128, 128, 40000);
	test_ABt(28 * 28, 256, 256, 10000);
	test_ABt(14 * 14, 128, 128, 160000);
	test_ABt(14 * 14, 256, 256, 40000);
	test_ABt(14 * 14, 512, 512, 10000);*/

	/*test_ABt(64, 56 * 56, 32, 1000);
	test_ABt(128, 56 * 56, 64, 1000);
	test_ABt(256, 56 * 56, 128, 1000);

	test_ABt(56 * 56, 64, 32, 1000);
	test_ABt(56 * 56, 128, 64, 1000);
	test_ABt(56 * 56, 256, 128, 1000);*/


	/*test_ABt(56 * 56, 16, 3 * 3 * 3, 1000);
	test_ABt(56 * 56, 32, 3 * 3 * 3, 1000);
	test_ABt(56 * 56, 64, 3 * 3 * 3, 1000);

	test_ABt(56 * 56, 16, 3 * 3 * 8, 1000);
	test_ABt(56 * 56, 32, 3 * 3 * 8, 1000);
	test_ABt(56 * 56, 64, 3 * 3 * 8, 1000);
	test_ABt(56 * 56, 128, 3 * 3 * 8, 1000);

	test_ABt(56 * 56, 16, 3 * 3 * 16, 1000);
	test_ABt(56 * 56, 32, 3 * 3 * 16, 1000);
	test_ABt(56 * 56, 64, 3 * 3 * 16, 1000);
	test_ABt(56 * 56, 128, 3 * 3 * 16, 1000);*/

...
extern "C" {
	...
	void zq_cnn_depthwise_conv_no_padding_32f_align128bit_general_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_depthwise_conv_no_padding_32f_align256bit_general_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_depthwise_conv_no_padding_32f_align128bit_kernel3x3_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_depthwise_conv_no_padding_32f_align256bit_kernel3x3_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 4 (i.e. 1,2,3), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align128bit_kernel3x3_C4_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 8 (i.e. 1,2,3,4,5,6,7), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align256bit_kernel3x3_C8_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 8 (i.e. 5,6,7), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align128bit_kernel3x3_C8_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 16 (i.e. 9,10,11,12,13,14,15), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align256bit_kernel3x3_C16_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 16 (i.e. 13,14,15), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align128bit_kernel3x3_C16_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 32 (i.e. 25,26,27,28,29,30,31), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align256bit_kernel3x3_C32_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 32 (i.e. 29,30,31), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align128bit_kernel3x3_C32_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 64 (i.e. 57,58,59,60,61,62,63), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align256bit_kernel3x3_C64_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 64 (i.e. 61,62,63), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align128bit_kernel3x3_C64_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 128 (i.e. 121,122,123,124,125,126,127), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align256bit_kernel3x3_C128_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 128 (i.e. 125,126,127), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align128bit_kernel3x3_C128_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 256 (i.e. 249,250,251,252,253,254,255), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align256bit_kernel3x3_C256_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 256 (i.e. 253,254,255), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align128bit_kernel3x3_C256_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	/*if C is not 512 (i.e. 505,506,507,508,509,510,511), the padded channels of filters must be zero*/
	void zq_cnn_depthwise_conv_no_padding_32f_align256bit_kernel3x3_C512_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,

...
#if __ARM_NEON
#define zq_cnn_deconv_with_padding_gemm_32f_k2s2 zq_cnn_deconv_with_padding_gemm_32f_align128bit_k2s2
...
#endif
#include "zq_cnn_deconvolution_gemm_32f_align_c_raw.h"
#undef zq_cblas_sgemm
#undef zq_CblasRowMajor
#undef zq_CblasNoTrans
#undef zq_CblasTrans

#undef zq_cnn_deconv_with_padding_gemm_32f_k2s2
#undef zq_mm_load_ps
...
#if __ARM_NEON_FP16
#define zq_cnn_deconv_with_padding_gemm_32f_k2s2 zq_cnn_deconv_with_padding_gemm_16f_align128bit_k2s2
...
#if ZQ_CNN_USE_SSETYPE >= ZQ_CNN_SSETYPE_AVX
#define zq_cnn_deconv_with_padding_gemm_32f_k2s2 zq_cnn_deconv_with_padding_gemm_32f_align256bit_k2s2

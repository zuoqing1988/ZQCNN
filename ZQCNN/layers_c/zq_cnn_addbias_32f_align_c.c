...
#define zq_cnn_addbias_32f_align_omp zq_cnn_addbias_32f_align128bit_omp
...
#undef zq_cnn_addbias_32f_align_omp
#undef zq_mm_load_ps
...
#define zq_cnn_addbias_32f_align_omp zq_cnn_addbias_32f_align256bit_omp
...
#pragma omp parallel for schedule(static, chunk_size) num_threads(thread_count)
		...
		{
			int n, h, w;
			float* c_ptr = in_tensor4D_data + c;
			float bias_v = *(bias_data + c);

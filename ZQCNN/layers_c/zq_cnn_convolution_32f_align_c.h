...
extern "C" {
	...
	void zq_cnn_conv_no_padding_32f_align128bit_kernel1x1_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_conv_no_padding_32f_align128bit_kernel2x2_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_conv_no_padding_32f_align128bit_kernel3x3_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_conv_no_padding_32f_align128bit_kernel3x3_C3_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_conv_no_padding_32f_align128bit_kernel5x5_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_conv_no_padding_32f_align128bit_general_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_conv_no_padding_32f_align256bit_kernel1x1_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_conv_no_padding_32f_align256bit_kernel2x2_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_conv_no_padding_32f_align256bit_kernel3x3_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_conv_no_padding_32f_align256bit_kernel3x3_C3_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_conv_no_padding_32f_align256bit_kernel5x5_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,
	...
	void zq_cnn_conv_no_padding_32f_align256bit_general_omp(
		const float* in_tensor4D_data,
		int in_N,
		int in_H,
		int in_W,

...
#include "ZQ_FaceRecognizerArcFaceNCNN.h"
...
int make_database(int argc, char** argv, bool compact, int mode_size)
{
	...
	std::vector<ZQ_FaceRecognizerArcFaceNCNN> recognizer_112X112(max_thread_num);
	std::vector<ZQ_FaceRecognizerSphereFaceNCNN> recognizer_112X96(max_thread_num);

...
bool EvaluationArcFaceZQCNNOnLFW(const std::string& prototxt_file, const std::string& caffemodel_file, const std::string& out_layer_name,
	const std::string& list_file, const std::string& folder, int max_thread_num = 4, bool use_flip = false)
{
	...
	{
		recognizers[i] = new ZQ_FaceRecognizerArcFaceOpenCV();

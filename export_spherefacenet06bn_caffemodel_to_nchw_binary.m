function export_spherefacenet06bn_caffemodel_to_nchw_binary()
caffe.set_mode_cpu();
...
caffe_net  = caffe.Net('sphereface06bn_deploy.prototxt', 'sphereface06bn_model_iter_86000.caffemodel', 'test');
out_file = 'sphereface06bn_iter_86000.nchwbin';

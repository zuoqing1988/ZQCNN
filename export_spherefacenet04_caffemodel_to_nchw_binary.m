...
function export_spherefacenet04_caffemodel_to_nchw_binary()
caffe.set_mode_cpu();

caffe_net  = caffe.Net('sphereface04_deploy.prototxt', 'sphereface04_model_iter_40000.caffemodel', 'test');
...
export_to_binary(layers,caffe_net,'sphereface04_iter_40000.nchwbin');
end
